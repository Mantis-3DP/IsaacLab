...
from . import agents, fixed_base_upper_body_ik_g1_env_cfg, locomanipulation_g1_camera_env_cfg, locomanipulation_g1_env_cfg

gym.register(
    id="Isaac-PickPlace-Locomanipulation-Camera-G1-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": locomanipulation_g1_camera_env_cfg.LocomanipulationG1CameraEnvCfg,
